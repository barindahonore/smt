                ...
                (function () {
                        ...
                        return t.prototype.init = function () {
                            ...
                            for (var a, o, r, l, d, c, h = function (t, e, s) {
                                var i = t.childNodes ? w(t.childNodes.length, !0) : [],
                                    n = e.childNodes ? w(e.childNodes.length, !0) : [], a = 0;
                                ...
                                if (!0 === u[b]) if ("#text" === (l = t.childNodes[_]).nodeName) if ("#text" === e.childNodes[b].nodeName) {
                                ...
                                } else m.push((new x).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)), u.splice(b, 1), f = Math.min(u.length, p.length), b -= 1; else m.push((new x).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))), u.splice(b, 1), f = Math.min(u.length, p.length), b -= 1; else if (!0 === p[b]) "#text" === (l = e.childNodes[b]).nodeName ? (m.push((new x).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)), u.splice(b, 0, !0), f = Math.min(u.length, p.length), _ -= 1) : (m.push((new x).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))), u.splice(b, 0, !0), f = Math.min(u.length, p.length), _ -= 1); else if (u[b] !== p[b]) {
                        ...
                        nodeName: "TR", childNodes: t.map(((t, h) => {
                            ...
                            return {
                                ...
                                childNodes: !a && !r.length || c ? u.sortable && o ? [{
                                    nodeName: "BUTTON",
                                    attributes: {class: u.filter ? i.filter : i.sorter},
                                    childNodes: m
                    ...
                    class K {
                        ...
                        init() {
                            ...
                            this.buttonDOM = t, this.containerDOM = s("div", {id: this.options.classes.container}), this.wrapperDOM = s("div", {class: this.options.classes.wrapper}), this.menuDOM = s("ul", {
                    ...
                    exports.DataTable = class {
                        constructor(t, e = {}) {
                            ...
                            const i = {...J.diffDomOptions, ...e.diffDomOptions}, n = {...J.labels, ...e.labels},
                            ...
                            this.options = {
                                ...
                                labels: n,
                                classes: a
                            }, this._initialInnerHTML = this.options.destroyable ? this.dom.innerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new L(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }

                        init() {
                            if (this.initialized || this.dom.classList.contains(this.options.classes.table)) return !1;
                            this._virtualDOM = M(this.dom, this.options.diffDomOptions || {}), this._tableAttributes = {...this._virtualDOM.attributes}, this.rows = new z(this), this.columns = new U(this), this.data = F(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
